...
# 2. Without running the code, what will these lines return?
5 == 5.0
...
# In other words, what index is 50 in this list?
numlist = range(1, 101)
...
locations = {'Sinan': ['San Francisco', 'CA'], 'Brandon': ['Arlington', 'VA']}
